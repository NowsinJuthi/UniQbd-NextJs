      ...
      <div className="">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {games.map((game) => (
            <div
              key={game.id}
              className=" bg-card rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer p-6 flex flex-col items-center justify-center"
            >
              <img
                src={game.img}
                alt={game.name}

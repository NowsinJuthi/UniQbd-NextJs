...
const CategoryPage = () => {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get("https://uniqbd-nextjs-3.onrender.com/api/v1/category");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post("https://uniqbd-nextjs-3.onrender.com/api/v1/category", { name });
      setName("");
      fetchCategories();
    } catch (error) {
      console.log(error);
  ...
  const deleteCategory = async (id) => {
    ...
    try {
      await axios.delete(`https://uniqbd-nextjs-3.onrender.com/api/v1/category/${id}`);
      fetchCategories();
    } catch (error) {
      console.log(error);
    }
  ...
  const saveEditing = async (id) => {
    ...
    try {
      await axios.put(`https://uniqbd-nextjs-3.onrender.com/api/v1/category/${id}`, {
        name: editingName,
      });
      setEditingId(null);
      setEditingName("");

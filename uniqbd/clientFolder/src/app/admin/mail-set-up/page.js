...
const Mailpage = () => {
  ...
  const saveSettings = async () => {
    try {
      const res = await axios.post(
        "https://uniqbd-nextjs-3.onrender.com/api/v1/smtp/save",
        form
      );
  ...
  const testConnection = async () => {
    try {
      const res = await axios.post(
        "https://uniqbd-nextjs-3.onrender.com/api/v1/smtp/test",
        {
          ...form,
  ...
  useEffect(() => {
    const getConfig = async () => {
      try {
        const res = await axios.get("https://uniqbd-nextjs-3.onrender.com/api/v1/get");
        if (res.data.data) {
          setForm((prev) => ({
            ...prev,
            ...res.data.data,

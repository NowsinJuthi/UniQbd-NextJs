...
const Review = () => {
  ...
  const getAllReviews = async () => {
    try {
      const res = await axios.get(
        "https://uniqbd-nextjs-3.onrender.com/api/v1/admin/all",
  ...
  const approveReview = async (id) => {
    try {
      await axios.put(
        `https://uniqbd-nextjs-3.onrender.com/api/v1/approve/${id}`,
        {},
        { withCredentials: true }
      );
  ...
  const editReview = async (review) => {
    ...
    try {
      await axios.put(
        `https://uniqbd-nextjs-3.onrender.com/api/v1/review/update/${review._id}`,
        {
          comment: newComment,
        },
        { withCredentials: true }
